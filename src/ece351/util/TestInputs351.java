...
public final class TestInputs351 {
	...
	public static Collection<Object[]> vFiles() {
		return vFiles(".*");
	}
	
	public static Collection<Object[]> vFiles(String filter) {
		filter = "^" + filter + "\\.vhd$";
		return oneD2twoD(Utils351.files("tests/v", filter));
	}
	
	public static Collection<Object[]> badVFiles() {
		return oneD2twoD(Utils351.files("tests/v/ungrammatical", "^.*\\.vhd$"));
	}
	
	public static Collection<Object[]> badDefVFiles() {
		return oneD2twoD(Utils351.files("tests/v/undefined-var", "^.*\\.vhd$"));
	}
	
	public static Collection<Object[]> desugaredVFiles() {
		return oneD2twoD(Utils351.files("tests/v/staff.out/desugared", "^.*\\.vhd$"));
	}
	
	public static Collection<Object[]> elaboratedVFiles() {
		return oneD2twoD(Utils351.files("tests/v/staff.out/elaborated", "^.*\\.vhd$"));
	}
	
	public static Collection<Object[]> processSplitVFiles() {
		return oneD2twoD(Utils351.files("tests/v/staff.out/split", "^.*\\.vhd$"));
	}
	
	public static Collection<Object[]> synthesizedFFiles() {
		return oneD2twoD(Utils351.files("tests/v/staff.out/synthesize", "^.*\\.f$"));
	}
