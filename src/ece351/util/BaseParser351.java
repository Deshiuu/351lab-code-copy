...
public abstract class BaseParser351 extends BaseParser<Object> {
	 ...
	 * this way we do not have to insert extra whitespace() rules after each
	...
	/**
	 * Check if an object is an instance of the given type, throw an exception if it is not.
	 * @param obj
	 * @param expectedType
	 * @throws IllegalArgumentException if expectedType is null
	...
	/**
	 * Check if the type of an object is exactly the same as the argument.
	 * @param obj
	 * @param expectedType
	 * @throws IllegalArgumentException if expectedType is null
	 * @return
