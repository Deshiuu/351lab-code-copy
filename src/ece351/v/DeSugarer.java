...
public final class DeSugarer extends PostOrderVVisitor {
	...
	public Expr visitXOr(final XOrExpr e) {
		...
		return new OrExpr(new AndExpr(new NotExpr(e.left), e.right), new AndExpr(new NotExpr(e.right), e.left));
...
//throw new ece351.util.Todo351Exception();
	...
	public Expr visitXNOr(final XNOrExpr e) {
		...
		return new NotExpr(new OrExpr(new AndExpr(new NotExpr(e.left), e.right), new AndExpr(new NotExpr(e.right), e.left)));
// TODO: short code snippet
//throw new ece351.util.Todo351Exception();
	}
