...
public final class TestWParboiledRecognizerReject extends BaseTest351 {

	private final File wave;

	public TestWParboiledRecognizerReject(final File wave) {
		this.wave = wave;
	}
	...
	public void reject() {
		...
		try {
			WParboiledRecognizer.recognize(input);
