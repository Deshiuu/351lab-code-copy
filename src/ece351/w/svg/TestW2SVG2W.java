...
public final class TestW2SVG2W extends BaseTest351 {
	...
	public void process() throws Exception {
		...
		final PinsLines studentpinslines = PinsLines.fromSVG(studentsvgfile.toURI(), TransformW2SVG.USE_DOM_XML_PARSER);
		...
		final PinsLines staffpinslines = PinsLines.fromSVG(staffURI, TransformW2SVG.USE_DOM_XML_PARSER);
